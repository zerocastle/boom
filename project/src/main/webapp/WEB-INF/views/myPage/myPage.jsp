...
$(document).ready(function(){
    ...
    <div id="mypage_tap" class="container bigdiv">
            <div class="jbtn btn-group mr-2" role="group" >
                    ...
                    <input onclick="location.href='/web/1tap';" type="button" value="상품" type="button" class="tap-btn btn btn-lg btn-secondary" />
                    <input onclick="location.href='/web/2tap';" type="button" value="상점문의" type="button" class="tap-btn btn btn-lg btn-dark"/>
                    <input onclick="location.href='/web/3tap';" type="button" value="상점찜" class="tap-btn btn btn-lg btn-secondary"/>
                    <input onclick="location.href='/web/4tap';" type="button" value="상점후기" class="tap-btn btn btn-lg btn-dark"/>
                    <input onclick="location.href='/web/5tap';" type="button" value="동네직플정보" class="tap-btn btn btn-lg btn-secondary"/>
            </div>
        <div id="incl-jack">
