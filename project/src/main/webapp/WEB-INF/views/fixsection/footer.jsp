               ...
               <form id="form2" class="form-style-1" action="/member/memberRegister" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                        ...
                        <input type='file' id="imgInp2" name="uploadFile"
                           ...
                           src="/resources/image/no-image.png" alt="사진을 선택"
                     ...
                     <span class="input-icon">
                        <div class="nickLine" style="display: inline-block;">
                           <input type="text" id="reg-nick" name="nickname"
                              class="form-control" placeholder="닉네임 입력 (10글자 이내)" maxlength="10"
                  ...
                  <div class="form-group">
                     <span class="input-icon"> <input type="number"
                        ...
                        placeholder="휴대폰번호 입력" max="99999999999" maxlength="11" oninput="maxLengthCheck(this)">
                     </span>
                  ...
                  <div class="col-md-6 col-login">
                     ...
                     <div class="form-group">
                        <span class="input-icon"> <input type="text"
                           ...
                           placeholder="점포명을 정확히 입력해주세요" maxlength="20" required
                     ...
                     <div class="form-group">
                        <span class="input-icon"> <input type="number"
                           ...
                           placeholder="사업자등록번호-10자리의 숫자" maxlength="10" oninput="maxLengthCheck(this)">
                        </span>
                     ...
                     <div class="form-group">
                        <span class="input-icon"> <i data-feather="lock"></i> <input
                           ...
                           class="form-control" maxlength="11" oninput="maxLengthCheck(this)"
                           placeholder="매장번호를 입력해주세요(숫자만 허용)">
                        </span>
   ...
   <script type="text/javascript">
      $(function() {
         ...
         $('#part_name').keyup(function(){
            $('.hideRegPartName').css('display','none');
         });
         
         $('#company_number').keyup(function(){
            $('.hideCompany_number').css('display','none');
         });
         
         $('#boss_name').keyup(function(){
            $('.hidePartBoss').css('display','none');
         });
         
         $('#part_phone').keyup(function(){
            $('.hidePartPhone').css('display','none');
         });
         
/*          $('#zip_code').keyup(function(){
            $('.hidePartZip').css('display','none');
         }); */
         ...
         $('#partner').click(function(e) {
            ...
            if($('#part_name').val() == ''){
               ...
               $('.hideRegPartName').css('display','block');
               return false;
            }
            
            if($('#company_number').val() == ''){
               
               $('.hideCompany_number').css('display','block');
               return false;
            }
            
            if($('#boss_name').val() == ''){
               
               $('.hidePartBoss').css('display','block');
               return false;
            }
            
            if($('#part_phone').val() == ''){
               
               $('.hidePartPhone').css('display','block');
               return false;
            }
            
            if($('#zip_code').val() == ''){
               
               $('.hidePartZip').css('display','block');
               return false;
            }
   ...
   <script type="text/javascript">
      $(function() {
            ...
            $.ajax({
               ...
               success : function(data){
                  ...
                  if (data == 0) {
                     ...
                     $('.hideRegNickCheck').css('display','block').css('color','green').html('사용가능한 닉네임입니다.');
                  } else {
                     $('#reg-nickCkeck').html("중복확인");
                     $('.hideRegNickCheck').css('display','block').css('color','red').html('사용중인 닉네임입니다.');
                  }
               },
         ...
         $('#reg-phone').keyup(function(){
            ...
            $('.hideRegPhone').css('display','none');
         });
         
         $('#reg-email').keyup(function(){
            
            $('.hideRegEmail').css('display','none');
         });
         
         $("#reg-acc_num").keyup(function(){
            
            $('.hideRegAcc').css('display','none');
         });
         
         $("#reg-acc_name").keyup(function(){
         ...
         $('#reg-submit').click(function(e) {
            ...
            if($('#reg-nickCkeck').text() != '확인완료'){
               $('.hideRegNickCheck').css('display','block').css('color','red').html('중복확인을 눌러주세요.');
               
               return false;
            }
            
            if($('#reg-nick').val() == ""){
               $('.hideRegNickCheck').css('display','block').css('color','red').html('닉네임을 입력해주세요.');
