      ...
      <div>
        <form action="#">
          <fieldset>
            ...
            <div>
              <label for="phone"></label><input type="text" id="phone" name="firstname" placeholder="휴대폰번호*숫자만허용">


              <span id="Msgph" class="none">aa</span>
              <span class="mobile">
            ...
            <div>
              <label for="phone1"></label> <input type="text" id="phone1" name="firstname" placeholder="인증번호 확인">
              <span id="Msgph1" class="none">aa</span>
              <span class="mobile2">
                <i class="fas fa-mobile-alt"></i>
              </span>
            </div>
            ...
            <div>
              <label for="pwd"></label> <input type="password" id="pwd" name="lastname" placeholder="8~16자의 영문,숫자,특수문자 사용"
                onblur="ck_pwd()">
              <span class="lock">
            ...
            <div>
              <label for="pwd_ck"></label> <input type="password" id="pwd_ck" name="lastname" placeholder="비밀번호 확인"
                onblur="ck_pwd2()">
              <span class="lock2">
                <i class="fas fa-lock"></i>
              </span>
            ...
            <div>
              <label for="email"></label> <input type="email" id="email" name="firstname"
                placeholder="이메일 (비밀번호 분실시 사용)" onblur="ck_email()">
              <span class="email">
            ...
            <div>
              <label for="name"></label> <input type="text" id="name" name="lastname" placeholder="닉네임"
                onblur="ck_name()">
              <span class="user">
              ...
              <div class="num">
                <input type="text" class="form-control" id="bankAccountNo" name="bankAccountNo" placeholder="계좌번호 입력"
                  required="required">
                <span class="num1">
