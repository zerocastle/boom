      ...
      <div>
        <form action="#">
          <fieldset>
            ...
            <button class="myButton">중복확인</button>
            ...
            <div>
              <label for="pwd"></label> <input type="password" id="pwd" name="lastname" placeholder="비밀번호"
                onblur="ck_pwd()">
              <span class="lock">
            ...
            <div>
              <label for="email"></label> <input type="email" id="email" name="firstname"
                placeholder="이메일 ( ex@codepen.com)" onblur="ck_email()">
              <span class="email">
