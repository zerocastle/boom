			...
			<div style="height: 740px;">
				...
				<div class="bb">
					...
					<form id="proRegi" method="post" enctype="multipart/form-data">
						...
						<div class="selling-addr">
							주소:
							<select value="addr">
								<option value="">---</option>
								<option value="경기도">1</option>
								<option value="강원도">2</option>
								<option value="충청남도">3</option>
								<option value="충청북도">4</option>
								<option value="경상북도">5</option>
								<option value="전라북도">6</option>
								<option value="경상남도">7</option>
								<option value="전라남도">8</option>
								<option value="제주도">9</option>
							</select>
						</div>
