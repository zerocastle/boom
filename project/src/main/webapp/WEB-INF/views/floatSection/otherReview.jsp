...
function fn_movePage(val) {
	...
	jQuery("form[name=frm]").attr("action", "")[0].submit();
}
</script>
		...
		<div class="col-md-4 col-lg-3">
			<div class="card">
				...
				<div class="list-group list-group-flush">
						 <a href="#" id="otherPro" class="list-group-item has-badge list-group-item-action">
						 <i data-feather="shopping-bag" class="mr-3"></i>${member.nickname }님의 상품<span class="badge rounded badge-primary">${proCount }</span></a>
						 <a href="#" id="review" class="list-group-item has-badge list-group-item-action active">
