...
<div class="sell">
	...
	<div class="ri">
		...
		<div class="myphone">
			<span class="myph">휴대폰 번호:</span> <span class="mynum">${member.phone}</span>
			<input type="text" class="mysu" />
			<hr
				style="border-color: gray; height: 1px; width: 850px; background: gray;">
		</div>


		<div class="myemail">
			<span class="mymail">E-Mail:</span> <span class="mycom">${member.email}</span>
		...
		<div class="mybank">
			<span class="mybname">은행명:</span> <span class="mybname1">${member.acc_name}</span>
			...
			</select> <span class="mybanum">계좌번호:</span> <span class="mybanum1">${member.acc_num}</span>
	...
	<div class="a1">
		...
		<div class="c1">
			...
			<div class="d1">
				...
				<sapn> <i class="fas fa-pencil-alt"></i></sapn>
			</div>
		</div>
	</div>
	...
	<div class="jimpro">
		...
		<div class="jimcont">
			...
			<div style="margin-top: 5px; margin-left: 2px;">
				<span class="proname1">상품명</span><input type="checkbox"
					class="prock">
			</div>
			<div style="margin-top: 5px; margin-left: 2px;">
