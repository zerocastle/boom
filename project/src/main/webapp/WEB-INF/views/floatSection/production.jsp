    ...
    $(function(){
       ...
       var getGPS = function(position){
          ...
          getPartner(lat,lon).then(function(data){
              ...
              var swiperWrapper = $('.slideshow-container');
              ...
              for(var i = 0; i < 5; i++){
                 ...
                 if(i==0){
                	 swiperWrapper.append("<div class='mySlides fadee' style='display:block;' > <img src='"+name+"'/' class='img1'> </div> ");	 
                 }else {
                	 swiperWrapper.append("<div class='mySlides fadee' > <img src='"+name+"'/' class='img1'> </div> ");
                 }
