       ...
       return b;
         ...
         $.ajax({
            ...
            success: function (data) {
                ...
                $('.img1').attr("src","http://39.127.7.51:8080/resources/"+data[0].Production_uploadVO[0].uploadPath.replace(/\\/g,'/') + '/s_' +data[0].Production_uploadVO[0].uuid + '_' + data[0].Production_uploadVO[0].fileName);
